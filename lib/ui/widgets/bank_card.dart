              ...
              children: <Widget>[
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Text(
                        ...
                        textAlign: TextAlign.left,
                        style: TextStyle(
                            color: card.bgAsset == 'assets/img/bg_purple_card.png' || card.bgAsset == 'assets/img/bg_blue_card.png' ? Colors.grey : Colors.black,
                            fontSize: 10.0,
                            fontWeight: FontWeight.bold),
                      ),
                      Padding(
                ...
                Padding(
                  ...
                  child: Text(
                    ...
                    textAlign: TextAlign.left,
                    style: TextStyle(
                        color: card.bgAsset == 'assets/img/bg_purple_card.png' || card.bgAsset == 'assets/img/bg_blue_card.png' ? Colors.grey : Color(0xFF253C70),
                        fontSize: 12.0,
                        fontWeight: FontWeight.bold),
                  ),
                ),
...
//      width: 150.0,
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          GestureDetector(
            child: Container(
              child: Image.asset('assets/img/ico_delete_card.png'),
            ),
          ),
        ],
      )
